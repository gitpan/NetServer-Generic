# This Makefile is for the NetServer::Generic extension to perl.
#
...
#	INC => q[]
#	LIBS => [q[]]
#	NAME => q[NetServer::Generic]
#	VERSION_FROM => q[Generic.pm]
...
AR_STATIC_ARGS = cr
NAME = NetServer::Generic
DISTNAME = NetServer-Generic
NAME_SYM = NetServer_Generic
VERSION = 0.03
VERSION_SYM = 0_03
XS_VERSION = 0.03
INST_BIN = blib/bin
...
FULLEXT = NetServer/Generic
BASEEXT = Generic
PARENT_NAME = NetServer
DLBASE = $(BASEEXT)
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/NetServer
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/NetServer
...
TO_INST_PM = Generic.pm \
	testguts.pl

PM_TO_BLIB = Generic.pm \
	$(INST_LIBDIR)/Generic.pm \
	testguts.pl \
	$(INST_LIBDIR)/testguts.pl
...
manifypods : pure_all Generic.pm
	@$(POD2MAN) \
	Generic.pm \
	$(INST_MAN3DIR)/NetServer::Generic.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f $(INST_LIBDIR)/Generic.pm $(INST_LIBDIR)/testguts.pl
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"NetServer-Generic\" VERSION=\"0,03,0,0\">\n}. qq{\t<TITLE>NetServer-Generic</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > NetServer-Generic.ppd
